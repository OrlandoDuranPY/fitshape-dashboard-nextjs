  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "rounded-(--cell-radius) bg-brand/20 text-brand font-semibold data-[selected=true]:rounded-none [&_button]:text-brand [&_button]:hover:text-brand",
